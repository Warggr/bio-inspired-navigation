...
def perform_look_ahead_2xnr(gc_network: GridCellNetwork, arena_size):
    ...
    max_distance = 1.1 * arena_size  # after this distance lookahead is aborted
    ...
    return goal_vector, goal_spiking
